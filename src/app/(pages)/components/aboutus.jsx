...
const Aboutus = () => {
  return (
    <div>
         <div>
          {about.map((rap)=> (
            <div className='flex flex-col justify-center items-center px-2 rounded-lg shadow-lg pb-5' key={rap.id}>
             ...
             <div className='flex justify-center items-center mt- py-9 px-5 xl:w-200 lg:w-200 rounded-lg shadow-lg'>
             <p className='pt-2 text-center text-gray-600 text-sm'><b>INOVAREUN</b> {rap.text}</p>
             </div>
            </div>
          ))}
        </div>
